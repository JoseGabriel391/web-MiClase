...
public class SvAltaAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/altaAdmin.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Administrador admin = con.crearAdmin(nombre, apellido, dni, direccion, pais, provincia, ciudad, fecNac, telefono, mail, usuarioId);
